...
export function EditWorkoutClient({ workout }: Props) {
  const router = useRouter();
  const [name, setName] = useState(workout.name);
  const [startDate, setStartDate] = useState<Date>(workout.startedAt);
  const [endDate, setEndDate] = useState<Date | null>(workout.completedAt);
